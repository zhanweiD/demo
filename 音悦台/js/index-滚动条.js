(function () {
  ...
  for (var i=0;i<aAll.length;i++){
    ...
    contentWrap.addEventListener("touchend", function () {
      ...
      if (endLateY>0){
        contentWrap.style.transition="0.5s cubic-bezier(.17,.67,.35,1.74)"
        transformCss(contentWrap,"translateY",0)
      }
    ...
    function endMove() {
        ...
        var speed=(endLateY-contentWrap.startlateY)/(endTime-startTime)
         contentWrap.style.transition="0.5s ease-out"
         transformCss(contentWrap, "translateY",endLateY+speed*100)
